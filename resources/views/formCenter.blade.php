            ...
            <table class="styled-table">
                ...
                <tbody>
                    <tr>
                        ...
                        <th>
                            <button class="edit-button" id="edit<?php echo $post->id; ?>" onclick="editFunction(<?php echo $post->id; ?>)">Edytuj</button>
                            <button class="delete-button" id="delete<?php echo $post->id; ?>" onclick="deleteFunction(<?php echo $post->id; ?>)">Usuń</button>
                        </th>
                    </tr>                    
                </tbody>
                @endforeach
...
<script>
    ...
    function editFunction(id){
        if(document.getElementById("edit" + id).innerHTML == "Edytuj"){
            ...
            document.getElementById("edit" + id).innerHTML = "Zapisz";
            // zmiana textu przycisku usuwania
            document.getElementById("delete" + id).innerHTML = "Anuluj";
        }else{
    ...
    function deleteFunction(id){
        if(document.getElementById("delete" + id).innerHTML == "Anuluj"){
            // wylaczenie edycji pol
            document.getElementById("name" + id).contentEditable = "false";
            document.getElementById("surname" + id).contentEditable = "false";
            document.getElementById("email" + id).contentEditable = "false";
            ...
            document.getElementById("edit" + id).innerHTML = "Edytuj";
            // zmiana textu przycisku usuwania
            document.getElementById("delete" + id).innerHTML = "Usuń";
        }else{
